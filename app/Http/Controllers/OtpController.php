...
class OtpController extends Controller
{
    ...
    public function otpWhatsapp(Request $request)
    {
        ...
        try{
            $result = file_get_contents("https://sambi.wablas.com/api/send-message?token=NirUvUwRNAl1wbpCCnTsfg2fqLycFqmIel8ir6K5DpYJSVe6vExEgrL7IEeVqp4O&phone=".$dataUser->telepon."&message=".'Hallo, ' . $dataUser->name . ' Berikut merupakan kode OTP untuk login pada website. ' . $otp . ' Terimakasih!');
            return $result;
        }catch(\Exception $e){
            return $e->getMessage();
        }
