...
<head>
    ...
    <title>Ende's Market | Register</title>
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group mb-3">
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Alamat Email" name="email" value="{{ old('email') }}" required autocomplete="email">
                        <div class="input-group-append">
                            <div class="input-group-text">
                ...
                <br>
                Sudah memiliki akun? <a href="{{route('login')}}" class="text-center">Masuk</a>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
