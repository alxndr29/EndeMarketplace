                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    Data Alamat:
                                    <br>
                                    Nama Penerima: <b>{Alexander Evan</b>
                                    <br>
                                    Alamat Lengkap: <b>Kokos Raya No 34</b>
                                    <br>
                                    Telp Penerima: <b>081353522525</b>
                                    <br>
                                    Kota: <b>Ende</b>
                                    <br>
                                    Kode Pos: <b>86317</b>
                                    <br>
                                    Provinsi: <b>Nusa Tenggara Timur</b>
                                    <br>
                                </div>
                                <div class="col">
                                    Data Pembayaran:
                                    <br>
                                    Jenis Pembayaran: <b>Cash On Delivery</b>
                                    <br>
                                    Total Belanja: <b> Rp. 50.000</b>
                                    <br>
                                    Biaya Pengiriman: <b>Rp. 5.000</b>
                                    <br>
                                    Nominal Penagihan: <b>Rp. 55.000</b>
                                    <br>
                                    Status: <b>Proses Kurir</b>
                                    <br>
