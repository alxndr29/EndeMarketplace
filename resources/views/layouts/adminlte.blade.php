    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{route('merchant.index')}}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Seller - Ende's Market</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{route('merchant.transaksi.index')}}" class="nav-link">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('merchant.pengantaran.index')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Daftar Pengantaran</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('merchant.petugas.index')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Petugas Pengantaran</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
